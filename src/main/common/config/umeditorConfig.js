import etpl from 'src/resources/lib/umeditor/third-party/template.min'
import pathsUtil from 'src/main/common/utils/pathUtil.js'
window.etpl = etpl;
etpl.config({
    commandOpen: '<%',
    commandClose: '%>'
...
var UMEDITOR_CONFIG = window.UMEDITOR_CONFIG  = {
      ...
      UMEDITOR_HOME_URL : pathsUtil.getBasePath()+'/src/resources/lib/umeditor/'
